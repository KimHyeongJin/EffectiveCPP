...
/*
"좌변 객체의 참조자를 반호나하게 만들자"라는 규약은 위에서 보신 단순 대입형 연산자 말고도 모든 형태의 대입 연산자에서 지켜저야 합니다.
*/
...
표준 라이브러리에 속한(혹은 조만간 속할 것들도 포함됩니다. 항목 54를 봐주세요) 모든 카입(string, vector, complex, tr1::shared_ptr 등)에서도 따르고 있다는 점은
